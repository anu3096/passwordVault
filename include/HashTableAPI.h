...
{
    char systemDescriptor[25];///< array that contains the system descriptor of a system
    char password[25];///< array that contains the password of a system
}Vault;
...
/**Function to return the index value calculated
 *@pre The hash table exists and has memory allocated to it, the system descriptor must be given
 *@param hashTable size, system descriptor
 *@return returns an integer value 'index' that has been calculated using the system descriptor and the hash table size.
 **/
